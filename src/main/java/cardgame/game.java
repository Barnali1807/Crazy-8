    ...
    public static void main(String[] args) {
        ...
        while (gameStatus == Status.CONTINUE) {
            ...
            if (nextUp == you) {
                ...
                // Reset every turn; reserved for scenarios where there are no cards to draw and
                // no cards to play
                ...
                while (!you.canPlayCardThisTopCard(newSuit, topCard)) {
                    ...
                    if (deck.size() != 0) {
                        ...
                        System.out.println("No cards to play. Player draws a: "
                                + you.getHand().get(you.numberOfCardsInHand() - 1));
                    } else {
                        you.setSkipStatus(true);
                        System.out
                                .println("No cards to play. No cards to draw from deck. Skipping " + you + "'s turn.");
                        break;
                    }
                }
                ...
                while (!computer.canPlayCardThisTopCard(newSuit, topCard)) {
                    ...
                    if (deck.size() != 0) {
                        ...
                        System.out.println(
                                "No cards to play. No cards to draw from deck. Skipping " + computer + "'s turn.");
                        break;
                    }
                }
