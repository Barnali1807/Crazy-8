...
public class Player implements PlayerActions {
    ...
    /**
     * Toggled to true once a player cannot play any cards in it's hand and there
     ...
     *
     * @param cardChoice The number assigned to the card via the command line
     *                   interface
     ...
     *
     * @return Nice string of your hand paired with numerical input required for a
     *         decision
     */
     ...
     *
     * @return Nice string of suits paired with numerical input required for a
     *         decision
     */
    ...
    public Card computerAi(String newSuit, Card topCard) {
        ...
        // Maintain that suit array and rank array are kept in parody with the hand we
        // are looping over
        ...
        if (newSuit.length() > 0) {
            ...
            for (String suitOrRank : waysToPlay) {
                ...
                // @TODO Alternatively I could have used lastIndexOf() instead of indexOf() in
                // both cases
        ...
        // @TODO The computer should ideally discard the card with the highest point
        // value
    ...
    public String computerSelectNewSuit() {
        ...
        Map<String, Long> counts = suits.stream()
                .collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
        String newSuit = counts.entrySet().stream()
    ...
    /**
     * Becomes true once a player cannot play a card in their hand and there are no
